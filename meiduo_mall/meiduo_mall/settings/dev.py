...
SECRET_KEY = '#)wi)*8a=nil8qmolszhyw66+4slq66%se+0c*no6=adh$h^^q'
...
# 使用别名为 "session" 的Redis配置项存储session数据
...
# 发送邮件的邮箱
EMAIL_HOST_USER = 'chenjianbing369@163.com'
# 在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = 'DOUSNZOTCOHATVJH'
# 收件人看到的发件人
EMAIL_FROM = '彭于晏<chenjianbing369@163.com>'
...
FDFS_URL = 'http://192.168.254.141:8888/'
...
# Haystack 是在Django中对接搜索引擎的框架，搭建了用户和索引之间的沟通桥梁
HAYSTACK_CONNECTIONS = {
    'default': {
        'ENGINE': 'haystack.backends.elasticsearch_backend.ElasticsearchSearchEngine',
        'URL': 'http://192.168.254.141:9200/', # Elasticsearch服务器ip地址，端口号固定为9200
